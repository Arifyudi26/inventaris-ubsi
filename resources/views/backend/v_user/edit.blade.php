...
<div class="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<form id="submitForm" action="{{ route('backend.user.update', $edit->id) }}" method="POST"
							...
							<div class="row">
								<div class="col-md-4 ">
									<div class="form-group">
										@if ($edit->foto)
										<img src="{{ asset('storage/img-user/' . $edit->foto) }}" id="fotoPreview"
											class="foto-preview rounded-circle" style="width: 200px; height:200px">
										<p></p>
										@else
										<img src=" {{ asset('img-user/img-default.jpg') }}" id="fotoPreview"
											class="foto-preview rounded-circle" style="width: 200px; height:200px">
										<p></p>
										@endif
