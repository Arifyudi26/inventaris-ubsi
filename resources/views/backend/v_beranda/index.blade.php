	...
	<div class="page-wrapper">
								...
								<div class="card-body border-top">
									<div class="alert alert-success">
										<h4 class="alert-heading">
											...
											Aplikasi inventaris dengan hak akses yang anda miliki sebagai
											<b>
												@if (Auth::user()->role == 1)
													Super Admin
		...
		{{-- <div class="page-breadcrumb">
			<div class="row">
				...
				<div>
					<p class="ml-2">Selamat Datanag <b>Administrator</b> pada plikasi Toko Online dengan hak akses yang anda miliki
						sebagai <b>Super
							Admin</b> ini adalah halaman utama dari aplikasi ini </p>
				</div>
			</div>
		</div> --}}
		{{-- <div class="container-fluid">
